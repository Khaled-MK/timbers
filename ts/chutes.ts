...
const materiau = document.getElementById("mat") as HTMLInputElement;
const finition = document.getElementById("finition") as HTMLInputElement;
const materiauxList = document.getElementById("materiaux") as HTMLDataListElement;
const finitionsList = document.getElementById("finitions") as HTMLDataListElement;
const resultDiv = document.getElementById("resultDiv") as HTMLDivElement;

type Chute = { ref: string; materiau: string; epaisseur: string; finition: string; largeur: number; hauteur: number; quantite: number };
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   materiauxUniques.forEach((materiau) => {
      ...
      const value = materiau as string;
      option.value = value;
   ...
   finitionsUniques.forEach((finition) => {
      const option = document.createElement("option");
      const value = finition as string;
      option.value = value;
...
function afficheChute(chutes: Chute[]) {
